    ...
    render () {
        return (
            <div className='mainContainer'>
                ...
                <div className='rowCentering'>
                    <div className='contentCentering contentBackground'>
                ...
                <div className='rowCentering'>
                    <div className='contentCentering'>
                        <h1 className='bottomContent'>Twitter/Instagram references and some photos</h1>
                        <p className='bottomContent'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veniam, optio cum a ab consequatur blanditiis velit! Ipsam voluptatibus voluptates animi accusamus, possimus quo officiis eos est laboriosam fuga incidunt excepturi.</p>
                    </div>
                </div>
            </div>
        )
