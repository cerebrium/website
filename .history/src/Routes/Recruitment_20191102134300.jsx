                        ...
                        <div className='contentCentering'>
                            <h3>Apply Now</h3>
                                <form action="" method='GET'>
                                    Have you held a full and valid UK or EU driving licence for at least one year?<br/>
                                    <input type="checkbox" value='licenseToDrive'/>yes </t>
                                    <input type="checkbox" value='licenseToDrive'/>no
                                </form>
                        </div>
                    </div>
                </div> 
